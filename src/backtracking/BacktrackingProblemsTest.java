...
public class BacktrackingProblemsTest {
    ...
    public void testIfSubsetsForAnArrayInSortedArrayWorks() {
        ...
        int[][] expectedArray = new int[][]{{1, 2, 3}, {1}, {2}, {3}, {1, 2}
                , {1, 3}, {2, 3}, {}};
        addArrayToListOfList(expectedSubsets, expectedArray);
    ...
    public void testifCombainationsFro4C2CanBeCalculatedCorrectly() {
        ...
        int[][] combinations = new int[][]{{1, 2}, {1, 3}, {1, 4}, {2, 3}, {2,
                4}, {3, 4}};
        addArrayToListOfList(expectedCombinations, combinations);
        List<List<Integer>> subsets =
    ...
    private void addArrayToListOfList(List<List<Integer>> expectedSubsets, int[][] expectedArray) {
        for (int[] array :
                expectedArray) {
            List<Integer> list = addArrayToListOfList(array);
